...
int main()
{
	...
	// ------------------------------------
	int orangeTriangleShaderProgram = createShaderProgram(vertexShaderSource, fragmentShaderSourceOrange);

	int yellowTriangleShaderProgram = createShaderProgram(vertexShaderSource, fragmentShaderSourceYellow);
